...
function Navbar() {
  ...
  return (
    <div>
      <div
        className={` flex justify-between overflow-x-auto p-8 ${
          theme === "dark"
      ...
      >
        ...
        <div>
          ...
          <ul
            className={`md:flex max-md:absolute ${
              theme === "dark" ? "bg-[#252528]" : "max-md:bg-slate-400"
            }  left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-700 ease-in-out top-16 md:space-x-4 ${
